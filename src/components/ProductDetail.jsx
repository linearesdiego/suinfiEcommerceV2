...
const ProductDetail = () => {
  ...
  return (
    <>
      <Navbar></Navbar>
      <div className="w-full h-full lg:h-[100vh] flex items-center justify-center flex-col">
        <div className="lg:flex lg:flex-row justify-between items-center mt-20 lg:mt-0">
          {isLoading && <Loader />}
          {!isLoading && (
            <div className="flex flex-col containerWidth">
              <div className="flex flex-col lg:flex-row justify-center items-center gap-5 lg:mt-[60rem]">
                <div className="">
                ...
                <div className="w-[50%] flex flex-col gap-9">
                  ...
                  <div className="flex flex-col gap-5 pb-10 lg:flex-row ">
                    <div className="flex w-full lg:w-[6rem] flex-row mr-7 justify-center bg-none gap-3 items-center px-0 border-[1px] border-[#000000] rounded-xl font-semibold text-center">
                      <button onClick={handleDecrement} className=''>-</button>

                      <p className="min-w-4">{cantidad}</p>
              ...
              <Payments/>
              <div className="h-[1px] w-full bg-[#b3b3b3] my-24"></div>
              <ReviewProduct />
              <div className="h-[1px] w-full bg-[#b3b3b3] my-24"></div>
            </div>
          )}
