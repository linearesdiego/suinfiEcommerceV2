...
export const CardsInfo = () => {
  return (
    <Swiper
      ...
      navigation={true}
      modules={[Navigation]}
      className="containerWidth flex flex-row justify-between my-20"
      breakpoints={{
        1520: {
          slidesPerView: 6, 
        },
    ...
    >
      ...
      <div class="bg-[#f2f2f2] w-56 h-[20rem] flex flex-col justify-center text-center px-4 gap-5 rounded-lg mx-auto md:mx-0">
            ...
            <a href="#" class="bg-[#e5e5e5] border-[1px] border-gray-500 rounded-full text-sm font-semibold py-[2px] w-[90%] mx-auto">Ingresa a tu cuenta</a>
        </div>
      </SwiperSlide>
      ...
      <div class="bg-[#f2f2f2] w-56 h-[20rem] flex flex-col justify-center text-center px-4 gap-5 rounded-lg mx-auto md:mx-0">
            ...
            <a href="#" class="bg-[#e5e5e5] border-[1px] border-gray-500 rounded-full text-sm font-semibold py-[2px] w-[90%] mx-auto">Ir a categorías</a>
        </div>
      </SwiperSlide>
      ...
      <div class="bg-[#f2f2f2] w-56 h-[20rem] flex flex-col justify-center text-center px-4 gap-5 rounded-lg mx-auto md:mx-0">
            ...
            <p class="font-semibold text-lg">Paga de la forma más rápida y segura</p>
            <a href="#" class="bg-[#e5e5e5] border-[1px] border-gray-500 rounded-full text-sm font-semibold py-[2px] w-[90%] mx-auto">Conocer medios de pago</a>
        </div>
      </SwiperSlide>
      ...
      <div class="bg-[#f2f2f2] w-56 h-[20rem] flex flex-col justify-center text-center px-4 gap-5 rounded-lg mx-auto md:mx-0">
            ...
            <a href="#" class="bg-[#e5e5e5] border-[1px] border-gray-500 rounded-full text-sm font-semibold py-[2px] w-[90%] mx-auto">Ir a mas vendidos</a>
        </div>
      </SwiperSlide>
      ...
      <div class="bg-[#f2f2f2] w-56 h-[20rem] flex flex-col justify-center text-center px-4 gap-5 rounded-lg mx-auto md:mx-0">
            ...
            <a href="#" class="bg-[#e5e5e5] border-[1px] border-gray-500 rounded-full text-sm font-semibold py-[2px] w-[90%] mx-auto">Cómo funciona</a>
        </div>
      </SwiperSlide>
